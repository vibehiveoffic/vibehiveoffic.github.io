class VibeHiveApp {
    ...
    init() {
        ...
        // Загрузить обсуждения если пользователь авторизован
        if (auth.currentUser) {
    ...
    renderDiscussion(discussion) {
        ...
        discussionEl.innerHTML = `
            ...
            <div class="discussion-actions">
                ...
                ${auth.currentUser && auth.currentUser.uid === discussion.authorId ? `
            ...
            <div class="comments-section" id="comments-${discussion.id}" style="display: none;">
                <div class="comment-input">
                    ...
                    <button class="btn-primary" onclick="app.addComment('${discussion.id}')">Отправить</button>
                </div>
